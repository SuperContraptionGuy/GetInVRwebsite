...
<html>
	<head>
		<title>Get_In_VR - Home</title>
<meta name="description" content="Get into VR today!  Serving the Utah area, we are on the front of the Virtual Reality wave.  Join us, you might even hang ten!" />
<meta name="keywords" content="Virtual Reality, GetInVR, Get In VR, Get In Virtual Reality, GetInVirtualReality, Gaming, Jack Fernald, Hudson Kendall, VR, Experience" />
          ...
          <div class="container">
            <div class="banner">
				<div class="wsite-section-elements">
					<h2 class="wsite-content-title" style="text-align:right;">Experience VR</h2>

<div class="paragraph" style="text-align:right;"><font size="4">Get Out of This World. &nbsp;Get In VR.</font></div>
				</div>
			</div>
          </div>
...
<h2 class="wsite-content-title" style="text-align:center;">Try virtual reality now!</h2>

<div class="paragraph" style="text-align:center;"><font color="#a8a8a8">We bring the limitless worlds of the past, present, future, and imagined worlds to you. &nbsp;Schedule an appointment to GetInVR now with friends and family!</font></div>

<div style="text-align:center;"><div style="height: 10px; overflow: hidden;"></div>
<a class="wsite-button wsite-button-large wsite-button-normal" href="reservations.html" >
<span class="wsite-button-inner">Schedule a Day</span>
</a>
...
<h2 class="wsite-content-title" style="text-align:center;"><font color="#ffffff">Interact with the world around you</font></h2>

<div class="paragraph" style="text-align:center;"><font color="#ffffff">With the intuitive controllers, the choices are put in your hands. &nbsp;Reach, grab, throw and manipulate without a second thought.</font></div>

<div style="text-align:center;"><div style="height: 10px; overflow: hidden;"></div>
<a class="wsite-button wsite-button-large wsite-button-highlight" href="reservations.html" >
<span class="wsite-button-inner">Schedule a Day</span>
</a>
<div style="height: 10px; overflow: hidden;"></div></div>
...
<div class="wsite-section-wrap">
	<div class="wsite-section wsite-body-section wsite-section-bg-image wsite-section-effect-parallax wsite-background-6 wsite-custom-background" style="height: 625px;background-image: url(&quot;/Assets/HudsonThumbsUp.jpg&quot;) ;background-repeat: no-repeat ;background-position: 31.22% 0.00% ;background-size: 100% ;background-color: transparent ;background-size: cover;background-attachment: fixed;" >
		<div class="wsite-section-content">
          <div class="container">
			<div class="wsite-section-elements">
				<div class="wsite-spacer" style="height:50px;"></div>

<h2 class="wsite-content-title" style="text-align:center;"><font color="#ffffff">Support Local Business</font></h2>

<div class="paragraph" style="text-align:center;"><font color="#ffffff">We are located in Northern Utah and serve the Wasatch Front.</font></div>
...
<div class="wsite-section-wrap">
	<div class="wsite-section wsite-body-section wsite-section-bg-color wsite-background-8 wsite-custom-background" style="background-color: #363B3E;background-image: none;is_customized: 1;" >
		<div class="wsite-section-content">
          <div class="container">
			<div class="wsite-section-elements">
				<div><div class="wsite-multicol"><div class="wsite-multicol-table-wrap" style="margin:0 -15px;">
...
<a>
<img src="Assets/JackOutlineBoarderedThick.png" alt="Picture" style="width:248;max-width:100%" />
</a>
...
<a>
<img src="Assets/you2-mainlogo-whiteletters.png" alt="Picture" style="width:auto;max-width:100%" />
</a>
<div style="display:block;font-size:90%"></div>
</div></div>
...
<div>
				...
				<div w3-include-html="newsletterForm.html"></div>
				<script>
				w3IncludeHTML();
				</script>
...
<div class="wsite-section-wrap">
	<div class="wsite-section wsite-body-section wsite-section-bg-color wsite-background-9 wsite-custom-background" style="background-color: #020000;background-image: none;is_customized: 1;" >
		<div class="wsite-section-content">
          <div class="container">
			<div class="wsite-section-elements">
				<div><div class="wsite-multicol"><div class="wsite-multicol-table-wrap" style="margin:0 -15px;">

...
<html>
	<head>
		<title>Catch us when we fly! - Get_In_VR</title>
...
//-->
	...
	<body class="header-page page-has-banner  wsite-theme-light  wsite-page-soon"><div class="wrapper">
	...
	<a href="">
		<img src="uploads/4/2/5/7/42575673/you2-mainlogo-whiteletters.png" />
	</a>
	...
	<div  class="wsite-section wsite-header-section wsite-section-bg-image" style="background-image: url(&quot;/uploads/4/2/5/7/42575673/background-images/793499445.jpg&quot;) ;background-repeat: no-repeat ;background-position: 100.00% 50.70% ;background-size: 110% ;background-color: transparent ;background-size: 110%;" >
		<div class="wsite-section-content">
			
          <div class="container">
            <div class="banner">
				<div class="wsite-section-elements">
					<h2 class="wsite-content-title">We're Not Open Yet :'(<br /></h2>
				</div>
			</div>
          </div>
	...
	<div class="wsite-section wsite-body-section wsite-background-15 wsite-custom-background"  >
		<div class="wsite-section-content">
          <div class="container">
			<div class="wsite-section-elements">
				<h2 class="wsite-content-title">Not to worry, we'll be there soon.</h2>

<div class="paragraph">We will email you when we have our Grand Opening so you can be of the first to GetInVR!</div>

<div>
				<form enctype="multipart/form-data" action="formSubmit.php"
				method="POST" id="form-575586389274113924">
					<div id="575586389274113924-form-parent" class="wsite-form-container"
					style="margin-top:10px;">
						<ul class="formlist" id="575586389274113924-form-list">
							<h2 class="wsite-content-title">Get Updates</h2>

<div><div class="wsite-form-field" style="margin:5px 0px 5px 0px;">
				<label class="wsite-form-label" for="input-665604750991656498">Email <span class="form-required">*</span></label>
				<div class="wsite-form-input-container">
					<input id="input-665604750991656498" class="wsite-form-input wsite-input wsite-input-width-370px" type="text" name="_u665604750991656498" />
				</div>
				<div id="instructions-665604750991656498" class="wsite-form-instructions" style="display:none;"></div>
			</div></div>
						</ul>
					</div>
					...
					<div style="text-align:left; margin-top:10px; margin-bottom:10px;">
						...
						<input type="hidden" name="ucfid" value="575586389274113924" />
						<input type='submit' style='position:absolute;top:0;left:-9999px;width:1px;height:1px' /><a class='wsite-button' onclick="document.getElementById('form-575586389274113924').submit()"><span class='wsite-button-inner'>Keep Me In The Loop</span></a>
					</div>
				</form>
